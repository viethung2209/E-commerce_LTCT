    ...
    return (
        <div className="container-fluid pt-5">
            <div className="text-center mb-4">
                <h2 className="section-title px-5"><span className="px-2">XU HƯỚNG</span></h2>
            </div>
            <div className="row px-xl-5 pb-3">
                <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div className="card product-item border-0 mb-4">
                        ...
                        <div className="card-footer d-flex justify-content-between bg-light border">
                            <a href="src/Component/Home/TrandyProducts" className="btn btn-sm text-dark p-0"><i
                ...
                <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div className="card product-item border-0 mb-4">
                        ...
                        <div className="card-footer d-flex justify-content-between bg-light border">
                            <a href="src/Component/Home/TrandyProducts" className="btn btn-sm text-dark p-0">
