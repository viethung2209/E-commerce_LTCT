            ...
            <div className="row px-xl-5">
                <div className="col-lg-8 table-responsive mb-5">
                    <table className="table table-bordered text-center mb-0">
                        ...
                        <tr>
                            <td className="align-middle">
                                <img src={require('../../../img/product-2.jpg')} alt="" style={{width:'50px'}}/>
                                Áo sơ mi sành điệu đầy màu sắc
                            </td>
                            <td className="align-middle">$150</td>
                            <td className="align-middle">
                        ...
                        <tr>
                            <td className="align-middle">
                                <img src={require('../../../img/product-3.jpg')} alt="" style={{width:'50px'}}/>
                                Áo sơ mi sành điệu đầy màu sắc
                            </td>
                            <td className="align-middle">$150</td>
                            <td className="align-middle">
                        ...
                        <tr>
                            <td className="align-middle">
                                <img src={require('../../../img/product-4.jpg')} alt="" style={{width:'50px'}}/>
                                Áo sơ mi sành điệu đầy màu sắc</td>
                            <td className="align-middle">$150</td>
                            <td className="align-middle">
                                <div className="input-group quantity mx-auto" style={{width:'100px'}}>
                                    <div className="input-group-btn">
                        ...
                        <tr>
                            <td className="align-middle">
                                <img src={require('../../../img/product-5.jpg')} alt="" style={{width:'50px'}}/>
                                Áo sơ mi sành điệu đầy màu sắc</td>
                            <td className="align-middle">$150</td>
                            <td className="align-middle">
                                <div className="input-group quantity mx-auto" style={{width:'100px'}}>
