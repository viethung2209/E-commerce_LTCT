                ...
                <div className="container-fluid py-5">
                    <div className="row px-xl-5">
                        ...
                        <div className="col-lg-7 pb-5">
                            <h3 className="font-weight-semi-bold">Áo sơ mi sành điệu đầy màu sắc</h3>
                            ...
                            <p className="mb-4">
                                Chi tiết Sản phẩm Áo sơ mi tay dài TILAA FASHION phối màu trắng đen phong cách Hàn Quốc
                                cho nam AS02
                                <br/>– Chất liệu vải lụa đẹp , không xù , không co rút , mềm mịn dày dặn , hút mồ hôi cực
                                    nhanh, mặc
                                    siêu
                                    mát .
                                    <br/>– Đảm bảo 100% cho sức khỏe người dùng.
                                    <br/>– Đây là món đồ một tủ quần áo cần phải có.Bạn có thể mặc nó hàng ngày.Phong
                                            cách thời trang
                                            đường
                                            phố.
                                            <br/>– Thiết kế mới, hiện đại, năng động, streetwear
                            </p>
                            <div className="d-flex mb-3">
